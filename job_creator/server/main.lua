...
--- Synchronise la flotte ox_garage avec jc_vehicles
function JC.SyncOxGarageFleet()
    if not Config.UseOxGarage then return end
    ...
    TriggerEvent('ox_garage:fullSyncJobFleet', list)
end
...
AddEventHandler('onResourceStart', function(res)
    if res == 'ox_garage' and JC.Ready then
        JC.SyncOxGarageFleet()
    end
end)
